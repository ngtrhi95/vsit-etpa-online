...
@Component({
    selector: "app-loveinsurance",
    templateUrl: "./loveInsurance.component.html",
    styleUrls: ["./loveInsurance.component.css"]
})
export class LoveInsuranceComponent implements OnInit {
    ...
    buyNow(option?) {
        ...
        const url = "product/human/lovepayment/" + this.grId + "/" + option;
