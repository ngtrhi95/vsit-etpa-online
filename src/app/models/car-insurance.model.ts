...
export class CarInsuranceOrder {
  ...
  constructor(
    ...
    public contractType: number = 5,
    public insuranceProductId: number = 0,
    public insuranceProgramId: number = 0,
    public insuranceProductCategoryId: number = 0,
    ...
    public takingPaperCertification: boolean = false,
